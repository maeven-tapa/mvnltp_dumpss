...
const unsigned long disturbedRecognitionDelay = 1000;  // 1 second (configurable)
...
float maxCapacity = 20000.0;  // Maximum capacity in grams (20kg load cell)
float calibrationFactor = 80.0;
...
// Long press tracking for Button 3 (Tare function)
...
void updateWeightDisplay() {
  ...
  // Display weight value with background color (only text pixels updated)
  tft.setTextSize(2);
  tft.setTextColor(ST77XX_BLACK, ST77XX_WHITE);
