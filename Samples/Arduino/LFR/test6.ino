    ...
    <div class="threshold-panel">
      ...
      <div class="threshold-control">
        ...
        <input type="range" id="thresholdSlider" class="threshold-slider" 
               min="0" max="4095" value="1700" step="10">
        <span id="thresholdValue" class="threshold-value">1700</span>
      </div>
      <div class="info">
        Adjust the threshold to calibrate line detection. Higher values = darker surface needed.
      </div>
    </div>
  ...
  <script>
    ...
    thresholdSlider.addEventListener('input', function() {
      ...
      fetch('/setThreshold?value=' + threshold)
        ...
        .then(data => console.log('Threshold updated:', threshold))
      ...
      fetch('/sensors')
        ...
        .then(data => {
          for (let i = 1; i <= 5; i++) {
            ...
            // Use current threshold value for animation
            if (value > threshold) {
