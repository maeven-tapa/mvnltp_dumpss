...
void followLine() {
  ...
  // Calculate motor speeds - SWAPPED THE CORRECTION SIGNS
  int leftSpeed = BASE_SPEED + correction;  // Changed from - to +
  int rightSpeed = BASE_SPEED - correction; // Changed from + to -
